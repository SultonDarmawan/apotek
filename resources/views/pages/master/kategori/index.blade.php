...
<style>
    ...
    /* Small circular buttons (edit/delete) */
    .btn-circle {
        width: 36px;
        height: 36px;
        padding: 6px;
    ...
    /* Remove default bootstrap hover bg, use subtle shadow instead */
    table.table-hover tbody tr:hover {
        background-color: transparent;
        box-shadow: inset 0 0 12px #d1d9e6;
    }

    /* Tooltip fix for neumorphic buttons */
    [data-original-title] {
        color: #333 !important;
    }
</style>
        ...
        <div class="col-lg-12">
            <div class="neumorphic-box">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h4>Data Kategori</h4>
                    <a href="{{ route('kategori.create') }}" class="neumorphic-btn">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('kategori.edit', $item->id) }}" class="btn-circle"
